...
This is an _example_ documentation for in-text citations and reference styles used in TWRI reports.
...
There are multiple bibliography manager softwares available that will manage and format references. [Zotero](https://www.zotero.org/) and [Mendeley](https://www.mendeley.com/) use Citation Style Language (`.csl`) files to format references. A `.csl` file specific to TWRI's in-house reference style is available on [Github](https://raw.githubusercontent.com/TxWRI/csl/main/texas-water-journal-name-year.csl).
